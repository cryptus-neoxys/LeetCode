...
<pre style="position: relative;"><strong>Input:</strong> numbers = [2,7,11,15], target = 9
...
<pre style="position: relative;"><strong>Input:</strong> numbers = [2,3,4], target = 6
<strong>Output:</strong> [1,3]
<div class="open_grepper_editor" title="Edit &amp; Save To Grepper"></div></pre>

<p><strong>Example 3:</strong></p>

<pre style="position: relative;"><strong>Input:</strong> numbers = [-1,0], target = -1
<strong>Output:</strong> [1,2]
<div class="open_grepper_editor" title="Edit &amp; Save To Grepper"></div></pre>
